...
def mk_narrative_payload(seed, window: str = "24h"):
    base_vol = 1_000_000
    base_liq = 500_000
    ct_mentions = 10_000
...
def mk_parent_ecosystem_stub(parent: str, narrative: str, k: int):
...
def main():
    ...
    (DATA_DIR / "discovered" / "parents-candidates-24h.json").write_text("[]", encoding="utf-8")
